TABLEAU FULL PORTFOLIO PROJECT
...
The project uses the Airbnb Listings dataset.
The Tableau workbook is built using the full dataset, while any reduced files were derived from the same source for simplification.
